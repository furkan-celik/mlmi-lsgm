python train_vada.py --data ./data/raw/kaggle/kermany2018/OCT2017/ --resize 256 --crop 256 --root MNIST \
        ...
        --weight_decay_norm_dae 0. --num_channels_dae 256 --train_vae  --num_cell_per_scale_dae 1 \
        ...
        --vae_checkpoint ../save_dir/vae/checkpoint.pt  --dae_arch ncsnpp --embedding_scale 1000 \
